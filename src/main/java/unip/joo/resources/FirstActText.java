...
public class FirstActText {
        ...
        put(
                ...
                "Suspenso no ar como um predador mecânico desperto, o drone lembrava um olho profano \n" +
                        "arrancado de algum pesadelo tecnológico. Seu núcleo era dominado por uma gigantesca lente azul pulsante \n" +
                        "uma íris artificial intensa e hipnótica que parecia observar tudo ao mesmo tempo, fria, precisa e impossível de enganar."
        );
        put(
                "pieceThree.beggar.six",
                "De sua carcaça metálica emergiam múltiplos braços articulados, semelhantes a tentáculos biomecânicos, \n" +
                        "cada um terminando em hélices giratórias que cortavam o ar com um zumbido ameaçador. \n" +
                        "Luzes vermelhas, azuis, verdes e âmbar piscavam como sinais de alerta vivos,\n" +
                        " dando à máquina a aparência de uma entidade consciente em constante vigilância."
        );
        put(
                "pieceThree.beggar.seven",
                "Sob o corpo principal, sensores adicionais pendiam como olhos secundários famintos \n" +
                        "por movimento, calor e falhas humanas. Cabos negros serpenteavam entre as estruturas metálicas,\n" +
                        " pulsando com energia enquanto o drone pairava com estabilidade antinatural, como se desafiasse \n" +
                        "não apenas a gravidade, mas também a própria ideia de máquina comum."
        );
