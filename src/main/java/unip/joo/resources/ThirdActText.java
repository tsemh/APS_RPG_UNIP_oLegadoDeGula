    ...
    private final Map<String, String> thirdAct = new LinkedHashMap<>() {{
        ...
        put("pieceOne.directcombat.initiative.failure.3",
                "A gosma se move como um organismo vivo, subindo lentamente pelas suas botas antes que você consiga reagir. O chão inteiro \n" +
                        "se ergue em silêncio, formando uma parede translúcida de matéria púrpura.");
...
// ATAQUES DA GULA
        ...
        put("combat.gula.consumoEnergia", "O céu escurece repentinamente. O vento para e e você começa a sentir um mal estar indescritível, como se suas celulas, seus músculosn\n"+
        "e toda sua energia vital estivesse sendo drenada. Olhando ao redor você nota todas as vidas ao redor estão murchando e morrendo. Um fluxo invisível corre em direção a Gula,\n" +
                " para seu núcleo e ela se recupera como se você sequer tivesse encostado nela.");
...
// ESQUIVA E ÚLTIMO FÔLEGO
        ...
        put("combat.victory.3",
                "Você respira com dificuldade. Seus pulmões queimam. Seus braços tremem. Seu corpo inteiro pede para cair.\n" +
        ...
        put("combat.victory.5",
                "Você não hesita e avança. O cano de metal sobe acima de sua cabeça.\n" +
        ...
        put("combat.victory.9",
                "Gula finalmente deixou de existir.\n\n" +
                        "Parado em meio aos destroços, você segura firmemente o cano de metal, agora frio e pesado.\n" +
                        "Cada respiração é uma batalha, seu peito dói, seu coração parece que vai destruir sua caixa torácica");
...
// DERROTA
        put("combat.defeat.2",
                "Você tenta permanecer de pé. Suas pernas cedem. Seus joelhos se dobram.\n" +
                        "O peso do próprio corpo é demais para suportar agora.");
        put("combat.defeat.3",
                "Caindo de joelhos no chão frio e úmido. O calor das queimaduras atravessa sua pele como fogo lento.\n" +
                        "Sangue escorre de feridas que você nem sentiu abrirem.");
        put("combat.defeat.4",
                "A instalação inteira pisca ao seu redor. Luzes alternam entre o brilho fraco e a escuridão total.\n" +
                        "Como se o local estivesse morrendo junto.");
        put("combat.defeat.5",
        ...
        put("combat.defeat.6",
                "Cada pulsação parece ecoar dentro de seu peito.\n\n" +
                        "Você erguer a arma mais uma vez. Seus dedos se recusam a obedecer.\n" +
                        "Os braços não respondem. Os músculos já não existem. Apenas dor. Apenas cansaço.");
        put("combat.defeat.7",
                "A criatura para diante de você. Tão perto que ele pode sentir a energia estática que emana de seu núcleo.\n" +
                        "Seus cabelos se erguem. Sua pele formiga.");
        put("combat.defeat.8",
                "Por um breve instante... o brilho roxo do núcleo reflete diretamente em seus olhos.\n" +
                        "você encara a própria morte refletida naquela luz.");
        put("combat.defeat.9",
        ...
        put("combat.defeat.12",
                "Seu corpo desaba no chão. Seus olhos ainda estão abertos, mas já não veem nada.\n" +
        ...
        put("gula",
        "Um colossal cubo translúcido, pulsando em tons de violeta e magenta, como se o próprio\n vazio tivesse aprendido a sangrar luz.");
        put("gula.1",
        "Seu corpo viscoso escorrendo lentamente pelo chão rachado, deixando rastros brilhantes \n"+
        "que pareciam consumir a realidade ao redor. Dentro daquela massa aberrante, restos de \n"+
        "humanos esquecidos flutuavam em silêncio eterno: ossos partidos, um crânio vazio, armas \n"+
        "condenadas e uma mão esquelética congelada em um último gesto de desespero.");
        put("gula.2",
        "No centro da criatura, um portal negro girando como um eclipse faminto\n"+
        " — um olho cósmico sem fundo, cercado por runas e estruturas profanas que vibravam com energia impossível. \n"+
        "Relâmpagos lilases rasgavam o céu acima dela, iluminando a chuva e revelando por breves instantes\n"+
        " a vastidão monstruosa daquela entidade gelatinosa.");
        put("gula.3",
        "Não é apenas uma criatura.");
        put("gula.4",
        "É um túmulo consciente.");
        put("gula.5",
        "Uma fome ancestral envolta em gosma luminosa.");
        put("gula.6",
        "Nada de magia esquecida, apenas a mais avançada tecnologia");
    }};
